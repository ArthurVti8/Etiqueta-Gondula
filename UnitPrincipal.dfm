object GeradorEtiquetas: TGeradorEtiquetas
  ...
  object FDQuery2: TFDQuery
    ...
    SQL.Strings = (
      'SELECT'
      '    P.au_ite AS CodigoProduto,'
      '    P.ab_ite + '#39' '#39' + P.ac_ite AS Descricao,'
      '    P.ad_ite AS CodigoUnidade,'
      '    p.ah_ite AS UnidadeMedida,'
      ...
      '    CE_PRODUTO P'
      'INNER JOIN'
      '    CE_PRODUTOS_ADICIONAIS A'
      '    ON P.au_ite = A.CodReduzido'
      'INNER JOIN'
      '    CE_PRODUTOS_IMPOSTOS I'

...
{$ENDIF}
  ...
  begin
    ...
    Band.SetBounds(0, 0, PageWidth, fr01cm * 7);
    CurY := 30;
  ...
  begin
    ...
    Band.CreateUniqueName;
    Band.SetBounds(0, CurY, PageWidth, fr01cm * 7);
  ...
  begin
    ...
    Band.CreateUniqueName;
    Band.SetBounds(0, CurY, PageWidth, 0);
  ...
  begin
    ...
    Band.CreateUniqueName;
    Band.SetBounds(0, 1000, PageWidth, fr01cm * 7);

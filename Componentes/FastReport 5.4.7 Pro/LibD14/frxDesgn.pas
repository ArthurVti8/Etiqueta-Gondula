...
{$ENDIF}
  ...
  TfrxDesignerForm = class(TfrxCustomDesigner)
    ...
    DockTop: {$IFNDEF FPC}TControlBar{$ELSE}TPanel{$ENDIF};
    TextTB: TToolBar;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Tag := i;
		if (Item.ButtonBmp <> nil) and (Item.ToolbarButtonImageIndex = -1) then
        begin
          Item.ToolBarButtonImageIndex := frxResources.MainButtonImages.Count;
          frxResources.SetButtonImages(Item.ButtonBmp);
        end;
	    	ImageIndex := Item.ToolbarButtonImageIndex;
...
begin
  {$IFDEF FPC}
  // FIX FOR TOOLBAR LISTBOX CLICK
  StyleCB.OnClick:= nil;
  StyleCB.OnCloseUp:= ToolButtonClick;
  FontNameCB.OnClick:= nil;
  FontNameCB.OnCloseUp:= ToolButtonClick;
  FontSizeCB.OnClick:= nil;
  FontSizeCB.OnCloseUp:= ToolButtonClick;
  StyleCB.OnClick:= nil;
  StyleCB.OnCloseUp:= ToolButtonClick;
  FrameWidthCB.OnClick:= nil;
  FrameWidthCB.OnCloseUp:= ToolButtonClick;
  LangCB.OnClick:= nil;
  LangCB.OnCloseUp:= LangCBClick;

...
class PASCALIMPLEMENTATION TfrxFrameSampleControl : public Controls::TCustomControl
{
...
public:
	/* TCustomControl.Create */ inline __fastcall virtual TfrxFrameSampleControl(Classes::TComponent* AOwner) : Controls::TCustomControl(AOwner) { }
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TfrxFrameSampleControl(void) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxFrameSampleControl(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	
};


class DELPHICLASS TfrxLineStyleControl;
class PASCALIMPLEMENTATION TfrxLineStyleControl : public Controls::TCustomControl
{
	typedef Controls::TCustomControl inherited;
...
public:
	__fastcall virtual TfrxLineStyleControl(Classes::TComponent* AOwner);
	virtual void __fastcall Paint(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxLineStyleControl(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	
};


class DELPHICLASS TfrxColorComboBox;
class PASCALIMPLEMENTATION TfrxColorComboBox : public Controls::TCustomControl
{
	typedef Controls::TCustomControl inherited;
	
private:
	Stdctrls::TComboBox* FCombo;
	Graphics::TColor FColor;
	bool FShowColorName;
	Classes::TNotifyEvent FOnColorChanged;
	bool FBlockPopup;
...
public:
	__fastcall virtual TfrxColorComboBox(Classes::TComponent* AOwner);
	virtual void __fastcall Paint(void);
...
public:
	/* TWinControl.CreateParented */ inline __fastcall TfrxColorComboBox(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }

...
public:
	...
	virtual void __fastcall ObjectOver(int Index, int X, int Y, Controls::TMouseButton Button, Classes::TShiftState Shift, System::Extended Scale, System::Extended OffsetX, System::Extended OffsetY, Controls::TCursor &Cursor, Frxclass::TfrxMouseIntEvents MouseEvent);

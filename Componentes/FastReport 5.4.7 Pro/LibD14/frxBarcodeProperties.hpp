...
// (DO NOT EDIT: machine generated header) 'Frxbarcodeproperties.pas' rev: 21.00
...
class PASCALIMPLEMENTATION TfrxBarcode2DProperties : public Classes::TPersistent
{
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source) = 0 ;
	void __fastcall SetWhose(System::TObject* w);
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TfrxBarcode2DProperties(void) { }
	
public:
	/* TObject.Create */ inline __fastcall TfrxBarcode2DProperties(void) : Classes::TPersistent() { }

...
'="clComprPreparedRepFilter" Text="Compressed prepared report (*.fp3)|*.fp3"/><StrRes Name="clSaving" Text="Saving file..."/><StrRes Name="clCancel" Te' + 
'xt="Cancel"/><StrRes Name="clClose" Text="Close"/><StrRes Name="clPrinting" Text="Printing page"/><StrRes Name="clLoading" Text="Loading file..."/><St' + 
'rRes Name="clPageOf" Text="Page %d of %d"/><StrRes Name="clOf" Text="of %d"/><StrRes Name="clFirstPass" Text="First pass: page "/><StrRes Name="clNoPr' + 
'inters" Text="No printers installed on your system"/><StrRes Name="clDecompressError" Text="Stream decompress error"/><StrRes Name="crFillMx" Text="Fi' + 
'lling the cross-tab..."/><StrRes Name="crBuildMx" Text="Building the cross-tab..."/><StrRes Name="prRunningFirst" Text="First pass: page %d"/><StrRes ' + 
'Name="prRunning" Text="Preparing page %d"/><StrRes Name="prPrinting" Text="Printing page %d"/><StrRes Name="prExporting" Text="Exporting page %d"/><St' + 
'rRes Name="uCm" Text="cm"/><StrRes Name="uInch" Text="in"/><StrRes Name="uPix" Text="px"/><StrRes Name="uChar" Text="chr"/><StrRes Name="dupDefault" T' + 
'ext="Default"/><StrRes Name="dupVert" Text="Vertical"/><StrRes Name="dupHorz" Text="Horizontal"/><StrRes Name="dupSimpl" Text="Simplex"/><StrRes Name=' + 
'"SLangNotFound" Text="Language ''%s'' not found"/><StrRes Name="SInvalidLanguage" Text="Invalid language definition"/><StrRes Name="SIdRedeclared" Text=' + 
'"Identifier redeclared: "/><StrRes Name="SUnknownType" Text="Unknown type: "/><StrRes Name="SIncompatibleTypes" Text="Incompatible types"/><StrRes Nam' + 
'e="SIdUndeclared" Text="Undeclared identifier: "/><StrRes Name="SClassRequired" Text="Class type required"/><StrRes Name="SIndexRequired" Text="Index ' + 
'required"/><StrRes Name="SStringError" Text="Strings do not have properties or methods"/><StrRes Name="SClassError" Text="Class %s does not have a def' + 
'ault property"/><StrRes Name="SArrayRequired" Text="Array type required"/><StrRes Name="SVarRequired" Text="Variable required"/><StrRes Name="SNotEnou' + 
'ghParams" Text="Not enough actual parameters"/><StrRes Name="STooManyParams" Text="Too many actual parameters"/><StrRes Name="SLeftCantAssigned" Text=' + 
'"Left side cannot be assigned to"/><StrRes Name="SForError" Text="For loop variable must be numeric variable"/><StrRes Name="SEventError" Text="Event ' + 
'handler must be a procedure"/><StrRes Name="600" Text="Expand all"/><StrRes Name="601" Text="Collapse all"/><StrRes Name="clStrNotFound" Text="Text no' + 
't found"/><StrRes Name="clCantRen" Text="Could not rename %s, it was introduced in the ancestor report"/><StrRes Name="rave0" Text="Rave Import"/><Str' + 
'Res Name="rave1" Text="The Rave file doesn''t contain TRaveReport items."/><StrRes Name="rave2" Text="The Rave file contains %d reports. Each report wi' + 
'll be converted to one fr3 file. Choose a directory where fr3 files will be saved. Note that only the last report will be opened in the designer."/><S' + 
'trRes Name="rave3" Text="Cannot create %s."/><StrRes Name="rave4" Text="Report %s, page %s."/><StrRes Name="clCirRefNotAllow" Text="Circular child ref' + 
'erence is not allowed"/><StrRes Name="clDupName" Text="Duplicate name"/><StrRes Name="clErrorInExp" Text="Error in Calc expression:"/><StrRes Name="ex' + 
'pMtm" Text="Timeout expired"/><StrRes Name="erInvalidImg" Text="Invalid image format"/><StrRes Name="ReportTitle" Text="ReportTitle"/><StrRes Name="Re' + 
'portSummary" Text="ReportSummary"/><StrRes Name="PageHeader" Text="PageHeader"/><StrRes Name="PageFooter" Text="PageFooter"/><StrRes Name="Header" Tex' + 
't="Header"/><StrRes Name="Footer" Text="Footer"/><StrRes Name="MasterData" Text="MasterData"/><StrRes Name="DetailData" Text="DetailData"/><StrRes Nam' + 
'e="SubdetailData" Text="SubdetailData"/><StrRes Name="Data4" Text="Data4"/><StrRes Name="Data5" Text="Data5"/><StrRes Name="Data6" Text="Data6"/><StrR' + 
'es Name="GroupHeader" Text="GroupHeader"/><StrRes Name="GroupFooter" Text="GroupFooter"/><StrRes Name="Child" Text="Child"/><StrRes Name="ColumnHeader' + 
'" Text="ColumnHeader"/><StrRes Name="ColumnFooter" Text="ColumnFooter"/><StrRes Name="Overlay" Text="Overlay"/><StrRes Name="2_5_interleaved" Text="2_' + 
'5_interleaved"/><StrRes Name="2_5_industrial" Text="2_5_industrial"/><StrRes Name="2_5_matrix" Text="2_5_matrix"/><StrRes Name="Code39" Text="Code39"/' + 
...
'/><StrRes Name="PostNet" Text="PostNet"/><StrRes Name="Codebar" Text="Codebar"/><StrRes Name="EAN8" Text="EAN8"/><StrRes Name="EAN13" Text="EAN13"/><S' + 
'trRes Name="UPC_A" Text="UPC_A"/><StrRes Name="UPC_E0" Text="UPC_E0"/><StrRes Name="UPC_E1" Text="UPC_E1"/><StrRes Name="UPC Supp2" Text="UPC Supp2"/>' + 
'<StrRes Name="UPC Supp5" Text="UPC Supp5"/><StrRes Name="EAN128A" Text="EAN128A"/><StrRes Name="EAN128B" Text="EAN128B"/><StrRes Name="EAN128C" Text="' + 
'EAN128C"/><StrRes Name="rpEditRep" Text="Edit Report..."/><StrRes Name="rpEditAlias" Text="Edit Fields Aliases..."/></Resources>' + 
' ';

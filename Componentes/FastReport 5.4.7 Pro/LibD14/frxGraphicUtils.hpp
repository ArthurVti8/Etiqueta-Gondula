...
enum TSubStyle { ssNormal, ssSubscript, ssSuperscript };
#pragma option pop
...
public:
	...
	void __fastcall SetText(Widestrings::TWideStrings* Text, bool FirstParaBreak = false);
	...
	__property Widestrings::TWideStrings* Text = {read=FText};
};

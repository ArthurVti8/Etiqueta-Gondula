...
typedef StaticArray<TRGBAWord, 4096> TRGBAWordArray;
...
__published:
	...
	Stdctrls::TCheckBox* TransparentCB;
...
typedef StaticArray<System::Byte, 16> TfrxPDFXObjectHash;
...
public:
	...
	double FDpiFX;
	int LastRemappedStrWidth;
	int LastRemappedStrSpacesCount;
	System::UnicodeString FSubstitutedFont;
...
private:
	typedef DynamicArray<TfrxPDFXObject> _TfrxPDFExport__1;
	
	typedef DynamicArray<int> _TfrxPDFExport__2;
...
private:
	...
	Classes::TStringList* FSubstitutedFonts;
	...
	Classes::TMemoryStream* FPageAnnots;
	Classes::TList* FAnnots;
	bool FPdfA;
	int FMetaFileId;
	int FStructId;
	int FColorProfileId;
	...
	System::AnsiString __fastcall StrToHexSp(const System::WideString SourceStr, const System::WideString Value, System::Extended SpaceAdjustment);
	...
	int __fastcall FindXObject(System::Byte const *Hash);
	int __fastcall AddXObject(int Id, System::Byte const *Hash);
	void __fastcall ClearXObject(void);
	void __fastcall GetStreamHash(/* out */ System::Byte *Hash, Classes::TStream* S);
	void __fastcall AddStructure(void);
	void __fastcall AddMetaData(void);
	void __fastcall AddColorProfile(void);
	void __fastcall WritePDFStream(Classes::TStream* target, Classes::TMemoryStream* source, int id, bool compressed, bool encrypted, bool startingBrackets, bool endingBrackets, bool enableLength2);
	void __fastcall DrawFrameLine(Graphics::TColor Color, Frxclass::TfrxFrameStyle FrameStyle, System::Extended FrameWidth, System::UnicodeString LeftBegin, System::UnicodeString TopBegin, System::UnicodeString LeftEnd, System::UnicodeString TopEnd);
...
__published:
	...
	__property bool PdfA = {read=FPdfA, write=FPdfA, nodefault};
public:
...
extern PACKAGE Classes::TStringList* frxPDFFontsNeedStyleSimulation;

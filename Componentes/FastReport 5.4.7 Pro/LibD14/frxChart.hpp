...
private:
	...
	Classes::TStringList* Fsl1;
	Classes::TStringList* Fsl2;
	Classes::TStringList* Fsl3;
	Classes::TStringList* Fsl4;
	Classes::TStringList* Fsl5;
	Classes::TStringList* Fsl6;
...
public:
	__fastcall virtual TfrxSeriesItem(Classes::TCollection* Collection);
...
__published:
	...
	__property Graphics::TColor HighlightColor = {read=FHighlightColor, write=FHighlightColor, default=-16777190};

...
class PASCALIMPLEMENTATION EDuplicateName : public Sysutils::Exception
{
	typedef Sysutils::Exception inherited;
	
public:
	/* Exception.Create */ inline __fastcall EDuplicateName(const System::UnicodeString Msg) : Sysutils::Exception(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EDuplicateName(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	/* Exception.CreateRes */ inline __fastcall EDuplicateName(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateName(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	/* Exception.CreateHelp */ inline __fastcall EDuplicateName(const System::UnicodeString Msg, int AHelpContext) : Sysutils::Exception(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EDuplicateName(const System::UnicodeString Msg, System::TVarRec const *Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDuplicateName(int Ident, int AHelpContext)/* overload */ : Sysutils::Exception(Ident, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDuplicateName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
...
enum Frxclass__3 { csContainer, csPreviewVisible, csDefaultDiff, csHandlesNestedProperties };
#pragma option pop

typedef Set<Frxclass__3, csContainer, csHandlesNestedProperties>  TfrxComponentStyle;
...
#pragma option push -b-
enum TfrxVisibilityType { vsPreview, vsExport, vsPrint };
#pragma option pop

typedef Set<TfrxVisibilityType, vsPreview, vsPrint>  TfrxVisibilityTypes;

#pragma option push -b-
enum TfrxPrintOnType { ptFirstPage, ptLastPage, ptOddPages, ptEvenPages, ptRepeatedBand };
#pragma option pop

typedef Set<TfrxPrintOnType, ptFirstPage, ptRepeatedBand>  TfrxPrintOnTypes;
...
#pragma option push -b-
enum TfrxFieldType { fftNumeric, fftString, fftBoolean, fftDateTime };
#pragma option pop
...
#pragma option push -b-
enum TfrxSerializeState { ssTemplate, ssPreviewPages };
#pragma option pop

#pragma option push -b-
enum TfrxHyperlinkKind { hkURL, hkAnchor, hkPageNumber, hkDetailReport, hkDetailPage, hkCustom };
#pragma option pop

#pragma option push -b-
enum TfrxFillType { ftBrush, ftGradient, ftGlass };
#pragma option pop
...
#pragma option push -b-
enum TfrxMouseIntEvents { meClick, meDbClick, meMouseMove, meMouseUp, meMouseDown };
#pragma option pop
...
typedef bool __fastcall (__closure *TfrxLoadDetailTemplateEvent)(TfrxReport* Report, const System::UnicodeString TemplateName, const TfrxHyperlink* AHyperlink);
...
class PASCALIMPLEMENTATION TfrxFillGaps : public Classes::TPersistent
{
...
public:
	/* TObject.Create */ inline __fastcall TfrxFillGaps(void) : Classes::TPersistent() { }
	
};


class DELPHICLASS TfrxCustomFill;
class PASCALIMPLEMENTATION TfrxCustomFill : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
	
public:
	virtual void __fastcall Draw(Graphics::TCanvas* ACanvas, int X, int Y, int X1, int Y1, System::Extended ScaleX, System::Extended ScaleY) = 0 ;
...
public:
	/* TObject.Create */ inline __fastcall TfrxCustomFill(void) : Classes::TPersistent() { }
...
public:
	...
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	virtual void __fastcall Draw(Graphics::TCanvas* ACanvas, int X, int Y, int X1, int Y1, System::Extended ScaleX, System::Extended ScaleY);
...
__published:
	...
	__property Graphics::TColor ForeColor = {read=FForeColor, write=FForeColor, default=0};
	__property Graphics::TBrushStyle Style = {read=FStyle, write=FStyle, default=0};
public:
...
__published:
	__property Graphics::TColor StartColor = {read=FStartColor, write=FStartColor, default=16777215};
	__property Graphics::TColor EndColor = {read=FEndColor, write=FEndColor, default=0};
...
#pragma option push -b-
enum TfrxGlassFillOrientation { foVertical, foHorizontal, foVerticalMirror, foHorizontalMirror };
#pragma option pop
...
class PASCALIMPLEMENTATION TfrxHyperlink : public Classes::TPersistent
{
	typedef Classes::TPersistent inherited;
...
public:
	...
	void __fastcall Draw(Graphics::TCanvas* Canvas, int FX, int FY, int FX1, int FY1, System::Extended ScaleX, System::Extended ScaleY);
...
private:
	...
	Graphics::TBrushStyle __fastcall GetBrushStyle(void);
	void __fastcall SetColor(const Graphics::TColor Value);
	Graphics::TColor __fastcall GetColor(void);
	void __fastcall SetHyperLink(const TfrxHyperlink* Value);
	void __fastcall SetFill(const TfrxCustomFill* Value);
...
public:
	virtual void __fastcall DoMouseMove(int X, int Y, Controls::TMouseButton Button, Classes::TShiftState Shift, bool &Refresh);
	virtual void __fastcall DoMouseUp(int X, int Y, Controls::TMouseButton Button, Classes::TShiftState Shift, bool &Refresh);
	...
	__property Graphics::TBrushStyle BrushStyle = {read=GetBrushStyle, write=SetBrushStyle, stored=false, nodefault};
	__property Graphics::TColor Color = {read=GetColor, write=SetColor, stored=false, nodefault};
...
class PASCALIMPLEMENTATION TfrxHighlight : public Classes::TCollectionItem
{
...
public:
	__fastcall virtual TfrxHighlight(Classes::TCollection* Collection);
...
__published:
	...
	__property Graphics::TColor Color = {read=GetColor, write=SetColor, stored=false, default=536870911};
...
class PASCALIMPLEMENTATION TfrxHighlightCollection : public Classes::TCollection
{
...
class PASCALIMPLEMENTATION TfrxFormat : public Classes::TCollectionItem
{
	typedef Classes::TCollectionItem inherited;
...
public:
	/* TCollectionItem.Create */ inline __fastcall virtual TfrxFormat(Classes::TCollection* Collection) : Classes::TCollectionItem(Collection) { }
...
class PASCALIMPLEMENTATION TfrxFormatCollection : public Classes::TCollection
{
	typedef Classes::TCollection inherited;
...
private:
	...
	void __fastcall WriteFormats(Classes::TWriter* Writer);
	void __fastcall WriteHighlights(Classes::TWriter* Writer);
	void __fastcall ReadFormats(Classes::TReader* Reader);
	void __fastcall ReadHighlights(Classes::TReader* Reader);
...
private:
	...
	void __fastcall SetPreviewPages(const TfrxCustomPreviewPages* Value);
...
public:
	...
	virtual void __fastcall DoMouseUp(TfrxView* Sender, int X, int Y, Controls::TMouseButton Button, Classes::TShiftState Shift, bool &Refresh);
...
private:
	...
	Classes::TNotifyEvent FOnBeforeExport;
...
__published:
	...
	__property Classes::TNotifyEvent OnBeforeExport = {read=FOnBeforeExport, write=FOnBeforeExport};
...
public:
	...
	virtual void __fastcall ObjectOver(int Index, int X, int Y, Controls::TMouseButton Button, Classes::TShiftState Shift, System::Extended Scale, System::Extended OffsetX, System::Extended OffsetY, Controls::TCursor &Cursor, TfrxMouseIntEvents MouseEvent) = 0 ;
...
extern PACKAGE TfrxCustomFill* __fastcall frxCreateFill(const TfrxFillType Value);
extern PACKAGE TfrxFillType __fastcall frxGetFillType(const TfrxCustomFill* Value);

...
extern PACKAGE void __fastcall frxParseDilimitedText(Classes::TStrings* aList, System::UnicodeString aText, System::WideChar aDelimiter);
...
extern PACKAGE void __fastcall frxWriteCollection(Classes::TCollection* Collection, Classes::TWriter* Writer, Frxclass::TfrxComponent* Owner)/* overload */;
extern PACKAGE void __fastcall frxWriteCollection(Classes::TCollection* Collection, const System::UnicodeString Name, Frxxml::TfrxXMLItem* Item, Frxclass::TfrxComponent* Owner, Frxcollections::TfrxCollection* aAncestor)/* overload */;
extern PACKAGE void __fastcall frxReadCollection(Classes::TCollection* Collection, Classes::TReader* Reader, Frxclass::TfrxComponent* Owner)/* overload */;
extern PACKAGE void __fastcall frxReadCollection(Classes::TCollection* Collection, Frxxml::TfrxXMLItem* Item, Frxclass::TfrxComponent* Owner, Frxcollections::TfrxCollection* aAncestor)/* overload */;
...
extern PACKAGE void __fastcall frxUpdateControl(Controls::TWinControl* AControl, const bool ARepaint = true);

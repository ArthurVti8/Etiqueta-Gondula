...
procedure TfrxPreview.LoadFromStream(Stream: TStream);
begin
  if FRunning then Exit;
  try
    Lock;
    ShowMessage(frxResources.Get('clLoading'));
    PreviewPages.LoadFromStream(Stream);
  finally
    PageNo := 1;
    UpdateOutline;
    Unlock;
...
procedure TfrxPreview.AddPreviewTabOrSwitch(AReport: TfrxReport; const TabName,
  TabCaption: String; FreeObjects: Boolean; aDetailPage: String);
begin
...
begin
  EnableControls([PrintB, SaveB, PdfB, EmailB, FindB, PageSettingsB],

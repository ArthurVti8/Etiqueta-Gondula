...
public:
	...
	void __fastcall AddPicture(Graphics::TGraphic* aGraphic, int &ImageIndex)/* overload */;
	void __fastcall GetPicture(Frxclass::TfrxPictureView* Picture)/* overload */;
	void __fastcall GetPicture(Graphics::TGraphic* aGraphic, int ImageIndex)/* overload */;

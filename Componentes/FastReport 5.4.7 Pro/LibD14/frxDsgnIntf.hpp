...
public:
	...
	Graphics::TBitmap* ButtonBmp;
	Graphics::TBitmap* WizardButtonBmp;
	int ButtonImageIndex;
...
public:
	...
	void __fastcall Register(Frxclass::TfrxWizardClass ClassRef, Graphics::TBitmap* ButtonBmp, bool IsToolbarWizard = false, Graphics::TBitmap* Bmp32x32 = (Graphics::TBitmap*)(0x0));

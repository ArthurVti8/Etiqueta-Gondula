...
// (DO NOT EDIT: machine generated header) 'Frx14.pas' rev: 21.00
...
#include <Frxedithyperlink.hpp>	// Pascal unit
#include <Frxeditfill.hpp>	// Pascal unit

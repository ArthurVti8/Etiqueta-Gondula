...
private:
	...
	void __fastcall SaveGraphic(Graphics::TGraphic* Graphic, Classes::TStream* Stream, System::Extended Width, System::Extended Height, Frximageconverter::TfrxPictureType PicType);

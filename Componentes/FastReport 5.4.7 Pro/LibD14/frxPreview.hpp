...
class PASCALIMPLEMENTATION TfrxPreviewTabItem : public Classes::TCollectionItem
{
...
public:
	...
	bool FreeObjects;
public:
	/* TCollectionItem.Create */ inline __fastcall virtual TfrxPreviewTabItem(Classes::TCollection* Collection) : Classes::TCollectionItem(Collection) { }
...
class PASCALIMPLEMENTATION TfrxPreviewTabs : public Classes::TCollection
{
...
private:
	...
	Comctrls::TTabControl* FTabs;
	bool FInitialized;
	bool FCalledFromPreview;
	TfrxPreviewTabs* FTabItems;
	Controls::TImageList* FTabImgList;
	...
	void __fastcall OnTabMouseUP(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
...
public:
	...
	void __fastcall AddPreviewTab(Frxclass::TfrxReport* AReport, const System::UnicodeString TabName, const System::UnicodeString TabCaption = L"", bool FreeObjects = true, System::UnicodeString aDetailPage = L"");
	void __fastcall AddPreviewTabOrSwitch(Frxclass::TfrxReport* AReport, const System::UnicodeString TabName, const System::UnicodeString TabCaption = L"", bool FreeObjects = true, System::UnicodeString aDetailPage = L"");
	void __fastcall RemoveTab(int TabIndex);
	bool __fastcall HasTab(const System::UnicodeString TabName)/* overload */;
	bool __fastcall HasTab(const Frxclass::TfrxReport* aReport)/* overload */;
	bool __fastcall HasVisibleTabs(void);
	void __fastcall SwitchToTab(const System::UnicodeString TabName)/* overload */;
	void __fastcall SwitchToTab(const Frxclass::TfrxReport* aReport)/* overload */;
...
__published:
	...
	__property Graphics::TColor ActiveFrameColor = {read=GetActiveFrameColor, write=SetActiveFrameColor, default=3983359};
	...
	__property Graphics::TColor FrameColor = {read=GetFrameColor, write=SetFrameColor, default=6316128};

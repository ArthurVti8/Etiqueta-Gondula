...
public:
	/* TfrxReport.Create */ inline __fastcall virtual TfrxHackReport(Classes::TComponent* AOwner) : Frxclass::TfrxReport(AOwner) { }
	/* TfrxReport.Destroy */ inline __fastcall virtual ~TfrxHackReport(void) { }
	
public:
	/* TfrxComponent.DesignCreate */ inline __fastcall virtual TfrxHackReport(Classes::TComponent* AOwner, System::Word Flags) : Frxclass::TfrxReport(AOwner, Flags) { }
...
__published:
	...
	void __fastcall ChartTreeChange(System::TObject* Sender, Comctrls::TTreeNode* Node);

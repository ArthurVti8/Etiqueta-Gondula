...
__published:
	...
	Comctrls::TToolButton* FrameEditB;
	...
	Menus::TPopupMenu* FontColorPopupMenu;
	Menus::TPopupMenu* FillColorPopupMenu;
	Menus::TPopupMenu* FrameColorPopupMenu;
	Comctrls::TToolButton* ToolButton1;
	Comctrls::TToolButton* FillEditB;
	Menus::TMenuItem* RevertInheritedMI;
	Menus::TMenuItem* RevertInheritedChildMI;
	Menus::TMenuItem* SelectAllOfTypeMI;
	Actnlist::TAction* SelectAllOfTypeCmd;
	Menus::TMenuItem* SelectAllOfTypeOnPageMI;
...
private:
	...
	void __fastcall ChangeGlyphColor(int Index, Graphics::TColor Color);

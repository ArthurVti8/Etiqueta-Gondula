...
// (DO NOT EDIT: machine generated header) 'Frxos2windowsmetricsclass.pas' rev: 21.00
...
{
//-- type declarations -------------------------------------------------------
typedef StaticArray<System::Byte, 4> TVendorID;

typedef StaticArray<System::Byte, 10> TPanose;
